...
SOURCES = \
	__init__.py \
	CadastralSuperimpose.py CadastralSuperimpose_dialog.py

PLUGINNAME = CadastralSuperimpose

PY_FILES = \
	__init__.py \
	CadastralSuperimpose.py CadastralSuperimpose_dialog.py

UI_FILES = CadastralSuperimpose_dialog_base.ui
...
QGISDIR=C:\Users\Ram_DFID\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
